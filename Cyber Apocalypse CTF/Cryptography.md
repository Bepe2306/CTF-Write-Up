...
In this challenge i was given a python code and an output text where i need to decode the encryption in order to get the flag
...
So i tried to analyze the code and with a little bit of help from chatGPT, i was able to get the decryption code
...
After i run this decrypt.py file, i was able to get the flag
